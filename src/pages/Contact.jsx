...
const FAQ_ITEMS = [
  {
    q: "What is Objekta?",
    a: "Objekta is a web-based 3D studio that enables real-time collaboration, studio-grade rendering, and asset management directly in your browser — no installation required.",
  },
  {
      ...
      <main className="home-shell" style={{ maxWidth: "1100px" }}>
        ...
        <section className="text-center" style={{ animation: "fade-up 0.7s ease-out" }}>
          ...
          <p className="hero-subtitle" style={{ maxWidth: "680px", margin: "0 auto" }}>
            Questions, feedback, or collaboration ideas — we're reachable by email and Discord.
          </p>
        </section>
        ...
        <section className="panel-glass" style={{ padding: "1.75rem 2rem", borderRadius: "16px", textAlign: "center" }}>
          <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", margin: 0 }}>
            Email support is available Mon–Fri. &nbsp;
